...
#
# Title abbreviations:
# 	 0 .. varia .. /home/ye/Data/Zoc/Cell/reference/data/qc/bowtie2/align/mouse/B1-1_L2_A007/variants.vcf
#
...
if plot_SNP_count_by_af:
	...
	if 0 in dat and len(dat[0])>2:
		ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='varia')
		has_data = 1
